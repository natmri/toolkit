  ...
  case 'linux':
    switch (arch) {
      ...
      case 'arm':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'platform-napi.linux-arm-musleabihf.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./platform-napi.linux-arm-musleabihf.node')
            } else {
              nativeBinding = require('@natmri/platform-napi-linux-arm-musleabihf')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 'riscv64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'platform-napi.linux-riscv64-musl.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./platform-napi.linux-riscv64-musl.node')
            } else {
              nativeBinding = require('@natmri/platform-napi-linux-riscv64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          localFileExisted = existsSync(
            join(__dirname, 'platform-napi.linux-riscv64-gnu.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./platform-napi.linux-riscv64-gnu.node')
            } else {
              nativeBinding = require('@natmri/platform-napi-linux-riscv64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 's390x':
        localFileExisted = existsSync(
          join(__dirname, 'platform-napi.linux-s390x-gnu.node')
        )
        try {
          if (localFileExisted) {
            nativeBinding = require('./platform-napi.linux-s390x-gnu.node')
          } else {
            nativeBinding = require('@natmri/platform-napi-linux-s390x-gnu')
          }
        } catch (e) {
          loadError = e
        }
...
const { RawEvent, setupInteractiveWindow, restoreInteractiveWindow, getDesktopIconVisibility, setDesktopIconVisibility, setMainWindowHandle, isDesktop, createShutdownBlocker, destroyShutdownBlocker } = nativeBinding
